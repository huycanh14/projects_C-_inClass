...
namespace Form12.frms
{
    public partial class frmKhoa : Form
    {
        ...
        public frmKhoa(string ServerName, string Database, string User, string Password) : this()
        {
        ...
        private void HienDanhSachKhoaLenDataGridView()
        {
            ...
            gvKhoa.DataSource = data.getKhoa(serverName, database, user, password);
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            string makhoa = txtMaKhoa.Text;
            UtilityDB data = new UtilityDB();
            bool kq = data.deleteKhoa(makhoa, serverName, database, user, password);
            if (kq == true)
            {
